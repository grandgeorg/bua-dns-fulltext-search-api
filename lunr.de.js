...
(function (root, factory) {
  ...
  return function (lunr) {
    ...
    lunr.de = function () {
      this.pipeline.reset();
      this.pipeline.add(lunr.de.trimmer, lunr.de.stopWordFilter, lunr.de.stemmer);
    };
      ...
      var Among = lunr.stemmerSupport.Among,
        ...
        st = new (function GermanStemmer() {
          var a_0 = [
            ...
            a_2 = [new Among("en", -1, 1), new Among("er", -1, 1), new Among("st", -1, 2), new Among("est", 2, 1)],
    ...
    lunr.de.stopWordFilter.stopWords.elements =
